...
<body class="bg-gradient-primary" >
    <nav class="navbar navbar-expand-lg navbar-light bg-light" style="background-color: #b3deeb;">
                ...
                <div class="col-lg-5 d-none d-lg-block bg-register-image"></div>
                    <div class="col-lg-7">
                        <div class="p-5">
                            ...
                            <form class="user" method="post" action="/signup" enctype="multipart/form-data">
                                @csrf
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-6">
                                        <select class="form-control" name="role" class="form-select" aria-label="Default select example" style="
                                        width: 250px;
                                        height: 50px;
                                        border-radius: 50px;
                                        border-color: #d1d3e2;
                                ...
                                <div class="form-group">
                                    <input name="image" type="file" class="form-control" id="customFile" style="height:50px; border-radius: 50px; padding-top:9px; color:#878585"/>
                                    @error('image')
                                        <p class="error text-danger" style="font-size: 15px; margin-left:10px; margin-top:6px; margin-bottom:0px">{{ "*".$message }}</p>
                                @enderror
                                </div>
