...
<body>
    <form class="user" method="post" action="/industryWork" enctype="multipart/form-data" style=" border-bottom: 1px solid #b7a9a9;">
        @csrf
        <nav class="navbar navbar-light bg-light" style="border-bottom: 1px solid black">
            <div class="navbar-brand">
                <a href=""><i class="fas fa-times"></i></a>
                <div class="pl-3 float-right">Industry Work</div>
            </div>
            <div class="btn-group" >
        ...
        <div class="container-fluid mt-3">
            ...
            <div class="row m-3" >
                ...
                <div class="col-lg-5 vl v p-4 mt-sm-2" style="height: 600px;">
                    <!-- Subject -->
                    <h6><i class="fas fa-clipboard"></i>  Subject</h6>
                    <div class="row">
                        <div class="col-6">
                            <select name="subject" class="form-control" name="">
