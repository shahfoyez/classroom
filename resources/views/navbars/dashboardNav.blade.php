    ...
    <ul class="navbar-nav ml-auto">
        ...
        <li class="nav-item dropdown no-arrow">
            ...
            <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in" aria-labelledby="userDropdown">
                ...
                @else
                    {{-- <a href="/assignmentCreate">Instructions</a>
                    <button class="dropdown-item" href="/industryWorkCreate">
                        <a href="/industryWorkCreate">Join</a>
                    </button> --}}
                    <a href="/industry/industryWorkCreate" class="dropdown-item">
                        Job Request
                    </a>
                @endif
            </div>
