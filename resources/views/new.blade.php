                                ...
                                @if ($assignment->assignmentSubmission->count()>0)
                                    ...
                                    @foreach ($assignment->assignmentSubmission as $submission)
                                        @if ($submission->user_id==$member->user->id )
                                            ...
                                            @break
                                        @else
                                            {{-- <td class="missing"><h1>Missing</h1> </td> --}}
                                        @endif
                                    @endforeach
                                @else
                                    <td class="missing"><h1>Missing</h1> </td>
                    ...
                    <div class="col-4 mb-4">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <iframe src="{{ asset('') }}" id="pdf-view" height="130" width="215px" frameborder="0px" title="Preview"  style="border:1px solid black;"></iframe>
